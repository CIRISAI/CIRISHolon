...
| 2 — magic (Clifford+T + rings) | **BUILT; native canonical form LANDED for evaluation** | ring tower; symbolic angles; native ZX with certified exact scalar — hidden-shift q=40 amplitude EXACT in 0.03 s (was TIMEOUT >900 s; quizx 21.5 ms): the ledger's worst loss closed for strong simulation. T-count oracle at 36–51% vs quizx 63–79% | remaining leg: the circuit EXTRACTOR (hand reduced diagrams back to the runner) + closing the T-oracle gap |
