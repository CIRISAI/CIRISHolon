...
**CORRECTION 2026-09-26 (REPLACE-1 G4, `conformance/replace1/REPLACE1_RESULTS.md`; the S1 row above kept legible).** "Dropping a KEPT gate moves the amplitude by `10⁻³`–`10⁻²` on 27 of 27" over-claims. The clause is the BEST kept T per instance, tried on the first four kept T at `n = 20` (the test's budget). Re-read under that same method it holds on **25 of 27** instances (`8.4 × 10⁻⁴` at `n 20, t 12, seed 2`; `2.7 × 10⁻¹⁸` at `n 20, t 16, seed 3`), and on 27 of 27 when every kept T is tried. Gate by gate, **150 of 248** kept T gates move the amplitude by more than `10⁻³`. The kill clause (removed gates `≤ 10⁻¹²`: 76 removed, worst `2.55 × 10⁻¹⁵`) is unaffected and was reproduced gate for gate.
