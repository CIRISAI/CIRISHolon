...
/// The worst knot on `generate_pair_table(O, O, 96)`, measured by `s3_oo_reexam` phase A.
const WORST_R: f64 = 4.224_4;
...
fn main() {
    ...
    println!("# O-O convergence trace at r = {r:.4} bohr, {} determinants", space.n_det);
