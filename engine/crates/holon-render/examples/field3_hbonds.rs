...
fn wall_from(out: &Path) -> Result<SeamModel, String> {
    ...
    let m = SeamModel { a, b, p: opt("p"), c: opt("c"), c6: opt("c6"), a_oh: opt("a_oh"), b_oh: opt("b_oh"), a_hh: opt("a_hh"), b_hh: opt("b_hh"), p_hh: opt("p_hh"), c_hh: opt("c_hh"), p_ct: opt("p_ct"), c_ct: opt("c_ct"), m_ct: opt("m_ct") as u8, k_ct: opt("k_ct") as u8, lambda_ct: opt("lambda_ct"), r_cut: opt("r_cut"), ct_table_on: false };
