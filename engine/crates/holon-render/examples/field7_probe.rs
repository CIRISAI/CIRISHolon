...
fn main() {
    ...
    let m = SeamModel { a: num(&t, "a"), b: num(&t, "b"), p: num(&t, "p"), c: num(&t, "c"), c6: num(&t, "c6"), a_oh: num(&t, "a_oh"), b_oh: num(&t, "b_oh"), a_hh: num(&t, "a_hh"), b_hh: num(&t, "b_hh"), p_hh: num(&t, "p_hh"), c_hh: num(&t, "c_hh"), p_ct: num(&t, "p_ct"), c_ct: num(&t, "c_ct"), m_ct: 0, k_ct: 0, lambda_ct: 0.0, r_cut: 0.0, ct_table_on: false };
